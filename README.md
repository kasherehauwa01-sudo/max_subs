...
4. Miniapp сразу запускает авто-отправку купона в личный чат с ботом (`POST /miniapp/start-subscribe-watch`) и открывает канал.
5. Пользователь подписывается на канал внутри MAX.
6. Купон приходит в личный чат с ботом автоматически.
...
3. при нажатии кнопки miniapp запускает авто-отправку купона в личный чат с ботом и открывает канал.
