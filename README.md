...
5. После нажатия `Подписаться на канал` купон отправляется автоматически в личный чат с ботом (через `POST /miniapp/start-subscribe-watch`) без дополнительной проверки подписки.
...
6. после нажатия «Подписаться на канал» miniapp запускает авто-отправку купона в личный чат с ботом без дополнительного нажатия.
...
- `POST /miniapp/start-subscribe-watch` — немедленный запуск авто-отправки купона в личный чат пользователя.
